...
(0, _jquery2.default)(function () {
    ...
    initUserMenu();
    (0, _jquery2.default)('#menu-button').on('click', toggleMenu);
    setActiveLink();
});

function initAreYouSureButtons() {
    (0, _jquery2.default)('.areyousure').click(function () {
        return window.confirm('Are you sure?');
    });
}

function initUserMenu() {
    var user = (0, _jquery2.default)('.user, .user-menu');
...
function toggleMenu() {
    (0, _jquery2.default)('#nav-icon').toggleClass('open');
    var links = (0, _jquery2.default)('.links');
...
function setActiveLink() {
    ...
    (0, _jquery2.default)('nav a[href="/' + activePage + '"]').addClass('active');
}
